...
<div class="row">
    ...
    <?php
        ...
        $sql=mysqli_query($conn,"SELECT * FROM productout WHERE uniqueprice='$_GET[upd]'");
...
if(isset($_POST['submit'])){
    ...
    $sql="UPDATE productout SET productcode='$prdctcode',quantity='$quantity',uniqueprice='$price',totalprice='$totalprice' WHERE uniqueprice='$_GET[upd]'";
